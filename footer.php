			...
			<div class="row">
				...
				<div class="span3">
					...
					<ul>
                        ...
                        <li><a href="<?php echo home_url(); ?>/support/donate/">Donate</a></li>
				...
				<div class="span3">
                    ...
                    <a href="http://bellevuecollege.edu"><img src="<?php bloginfo('stylesheet_directory'); ?>/img/bellevuecollege.png" alt="Bellevue College" /></a></div> <!--bclogo-->
