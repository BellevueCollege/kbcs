			...
			<div class="navbar top-mobile-nav">
				<div class="navbar-inner">
                	<div class="container">
                        ...
                        <a class="play-btn" href="http://t5.stationpanel.com/radio/?station=kbcs128" alt="Play button will play the live stream on click" title="Play live stream"><i class="icon-play pull-right"></i></a>
						<?php
